...
export async function GET(request) {
  try {
    ...
    const externalApiUrl = `http://37.27.120.45:5901/api/admin/rankingstelegramdata/specificFieldRankings?channel_id=${encodeURIComponent(channelId)}&fields=${encodeURIComponent(fields)}`;
