...
export async function GET(request) {
  try {
    ...
    console.log('YouTube rankings API response:', JSON.stringify(data, null, 2));
    ...
    console.error('Error fetching YouTube rankings data:', error);
    console.error('Error name:', error.name);
    console.error('Error message:', error.message);

    let errorMessage = 'Failed to fetch YouTube rankings data';
    let statusCode = 500;
