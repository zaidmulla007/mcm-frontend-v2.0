...
export async function GET(request) {
  try {
    ...
    const externalApiUrl = `http://37.27.120.45:5901/api/admin/influencertelegramdata/specificFieldsInfluencers?channel_id=${encodeURIComponent(channelId)}&fields=${encodeURIComponent(fields)}`;
