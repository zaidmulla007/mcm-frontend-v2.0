        ...
        <div className="flex flex-col gap-3 items-end">
          ...
          <div className="flex gap-3 items-center">
            ...
            <button
              ...
              className="bg-transparent border border-gray-300 text-to-purple hover:bg-gray-100 px-4 py-2 rounded text-sm font-medium transition-colors"
            >
              Clear
            </button>
            <button
              onClick={() => setShowAdvancedFilters(!showAdvancedFilters)}
              className="bg-[#c4c5e14d] border border-gray-300 rounded px-3 py-2 text-sm text-to-purple hover:bg-gray-100 flex items-center gap-2 transition-colors"
            >
              Advanced Filters
              <span
          ...
          {showAdvancedFilters && (
            <div className="flex gap-3 items-center">
              <div className="flex items-center gap-2">
                <span className="text-sm text-to-purple">Start Date:</span>
                <input
                  type="date"
                  value={startDate}
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-to-purple">End Date:</span>
                <input
                  type="date"
                  value={endDate}
