          ...
          <div className="mt-3 flex flex-wrap justify-start gap-4 text-sm text-gray-700">
            {(channelData?.messages_last_30_count !== undefined && channelData?.messages_last_30_count !== null) && (
              <div className="flex items-start gap-2">
                ...
                <span className="font-semibold text-gray-900 bg-blue-100 px-3 py-1 rounded-full">{channelData.messages_last_30_count} messages</span>
              </div>
            )}
            {(channelData?.messages_last_7_count !== undefined && channelData?.messages_last_7_count !== null) && (
              <div className="flex items-start gap-2">
                <span className="text-gray-600">Last 7 days:</span>
                <span className="font-semibold text-gray-900 bg-green-100 px-3 py-1 rounded-full">{channelData.messages_last_7_count} messages</span>
              </div>
            )}
            {(channelData?.messages_last_24h_count !== undefined && channelData?.messages_last_24h_count !== null) && (
              <div className="flex items-start gap-2">
                ...
                <span className="font-semibold text-gray-900 bg-purple-100 px-3 py-1 rounded-full">{channelData.messages_last_24h_count} messages</span>
              </div>
            )}
          </div>
          {/* {rank && (
