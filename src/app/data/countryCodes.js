export const countryCodes = [
  ...
  { name: "Congo, The Democratic Republic of the", code: "CD", dial_code: "+243", flag: "🇨🇩" },
  ...
  { name: "Holy See (Vatican City State)", code: "VA", dial_code: "+379", flag: "🇻🇦" },
  ...
  { name: "Korea, Democratic People's Republic of", code: "KP", dial_code: "+850", flag: "🇰🇵" },
  { name: "Korea, Republic of", code: "KR", dial_code: "+82", flag: "🇰🇷" },
  { name: "Kuwait", code: "KW", dial_code: "+965", flag: "🇰🇼" },
  { name: "Kyrgyzstan", code: "KG", dial_code: "+996", flag: "🇰🇬" },
  { name: "Lao People's Democratic Republic", code: "LA", dial_code: "+856", flag: "🇱🇦" },
  ...
  { name: "Libyan Arab Jamahiriya", code: "LY", dial_code: "+218", flag: "🇱🇾" },
  ...
  { name: "Micronesia, Federated States of", code: "FM", dial_code: "+691", flag: "🇫🇲" },
  { name: "Moldova, Republic of", code: "MD", dial_code: "+373", flag: "🇲🇩" },
  ...
  { name: "Palestinian Territory, Occupied", code: "PS", dial_code: "+970", flag: "🇵🇸" },
  ...
  { name: "Russian Federation", code: "RU", dial_code: "+7", flag: "🇷🇺" },
