...
export default function CoinsList() {
  ...
  return (
    <div className="app-container" style={{ padding: "20px", maxWidth: "1400px", margin: "0 auto" }}>
      <div className="controls" style={{ display: "flex", gap: 12, marginBottom: 40 }}>
        <input
                    ...
                    <div className="coin-right" style={{ textAlign: "right", minWidth: 100, flexShrink: 0 }}>
                      ...
                      >
                        {lp && lp.change24h !== undefined && lp.change24h !== null
                          ? `24hr (${lp.change24h >= 0 ? "+" : ""}${Number(lp.change24h).toFixed(2)}%)`
                          : "—"}
                      </div>
                    </div>
                  </div>
      ...
      {/* pagination centered */}
      <div className="pagination" style={{ marginTop: 40, marginBottom: 40, display: "flex", gap: 8, alignItems: "center", justifyContent: "center", flexWrap: "wrap" }}>
        <button
          className="page-btn"
        ...
        {pageButtons.map((p, i) =>
          p === "..." ? (
            <span
              ...
              className="page-btn"
              style={{ padding: "8px 14px", background: "transparent", border: "none", fontWeight: 600 }}
            >
              …
            </span>
          ) : (
      ...
      <div className="footer-note" style={{ marginTop: 0, color: "#6b7280", textAlign: "center", fontSize: 13 }}>
